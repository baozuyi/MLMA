...
def adam(params, grads, t_total, lr=0.0005, b1=0.9, b2=0.999, e=1e-8, l2=0.01, vector_l2=False, max_grad_norm=1, **kwargs):
    """
    ...
    for p, g in zip(params, grads):
        if p is None or g is None:
            ...
            schedule = partial(warmup_linear, warmup=0.002)
