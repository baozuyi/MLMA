...
params["save_path"] = "saved_models/model_layer_mv_enes" # path for saving model
...
params['layer_align_alpha'] = [0.1] * 7 
params['layer_align_beta'] = [0.01] * 7 
params['layer_align_gama'] = None #[1.0] * 7
