...
params['init_emb'] = {'en': prefix + "muse_enes/vectors-en.txt",
                      'es': prefix + "muse_enes/vectors-es.txt"}
params['is_train_emb'] = True # only work when init emb, should be True when init + warm up training emb

params["save_path"] = "saved_models/model_winit_layer_avl_enes" # path for saving model
...
params['learning_rate_emb_split'] = True
